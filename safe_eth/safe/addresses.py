...
MASTER_COPIES: Dict[EthereumNetwork, List[Tuple[str, int, str]]] = {
    ...
    EthereumNetwork.BOBA_BNB_MAINNET: [
        ...
        ("0x41675C099F32341bf84BFc5382aF534df5C7461a", 22285, "1.4.1"),  # v1.4.1
        (
            "0x29fcB43b46531BcA003ddC8FCB67FFE91900C762",
            22285,
            "1.4.1+L2",
...
PROXY_FACTORIES: Dict[EthereumNetwork, List[Tuple[str, int]]] = {
    ...
    EthereumNetwork.BOBA_BNB_MAINNET: [
        ...
        ("0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67", 22831),  # v1.4.1
    ],
    EthereumNetwork.BOBA_AVAX: [
    ...
    EthereumNetwork.BOBA_SEPOLIA: [
        ("0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67", 8927245),  # v1.4.1
        ("0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC", 8927245),  # v1.3.0
        ("0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2", 8927245),  # v1.3.0 default singleton address
    ],
    EthereumNetwork.AURORA_MAINNET: [
        (
            "0xC22834581EbC8527d974F8a1c97E1bEA4EF910BC",
